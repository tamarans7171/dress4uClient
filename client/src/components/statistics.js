...
function Statistics() {
  ...
  // Chart.register(CategoryScale);
    ...
    async function getPayments() {
        await axios.get("http://localhost:3000/payments/getPayments").then((resPay)=>{
    ...
    async function getDresses() {
        await axios.get("http://localhost:3000/dresses/getDresses").then(async(res)=>{
            let now = new Date()
            ...
            let cnt = 0
            await axios.get("http://localhost:3000/styles/getStyles").then((resStyles)=>{
